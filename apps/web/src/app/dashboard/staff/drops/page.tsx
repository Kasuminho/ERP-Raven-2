...
import { useDeliveredDrops } from '@/hooks/use-drops-api';
    ...
    <AuthGuard roles={['STAFF', 'ADMIN']}>
      <div className="space-y-6">
        <div>
          ...
          <h1 className="font-[var(--font-cinzel)] text-3xl font-bold">{t(locale, 'allDeliveredDrops')}</h1>
        </div>
        <Card>
          <CardHeader>
