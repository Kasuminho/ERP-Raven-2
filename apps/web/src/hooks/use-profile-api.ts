...
export function useUpdatePreferences() {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (data: { timezone?: string; locale?: string; eventReminderChannel?: EventReminderChannel }) => (await api.patch('/players/me/preferences', data)).data,
